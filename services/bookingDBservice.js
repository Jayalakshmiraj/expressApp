...
var service = {};
service.getBooking = function(movieid,callback){
  console.log(movieid);
  var sql = "SELECT * FROM movie where id="+movieid+"";
...
service.addCustomer = function(customer,callback) {
        ...
        connection.query("INSERT INTO booking set ? ",customer, function(err, results) {
          if(err){
